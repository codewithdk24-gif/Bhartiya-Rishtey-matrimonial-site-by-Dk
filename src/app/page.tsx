      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        <div className="relative animate-fade-in-up-delay-1 order-1 lg:order-2 z-10 -mx-6 lg:mx-0">
          <div className="relative">
            ...
            <div className="absolute bottom-12 left-12 bg-white/70 backdrop-blur-md rounded-xl border border-stone-200 p-3 items-center gap-3 animate-fade-in-up-delay-2 shadow-xl z-20 transition-transform hover:scale-105 hidden lg:flex">
            ...
            <div className="absolute top-12 right-12 bg-white/70 backdrop-blur-md rounded-xl border border-stone-200 p-3 items-center gap-3 animate-fade-in-up-delay-3 shadow-xl z-20 transition-transform hover:scale-105 hidden lg:flex">
        ...
        <div className="relative z-30 animate-fade-in-up order-2 lg:order-1 -mt-72 lg:mt-0 px-6 lg:px-0">
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/70 backdrop-blur-md border border-primary/20 mb-8 shadow-sm">
